    ...
    <>
      <div className="basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80">
        ...
        <div className="px-2 pt-4 pb-2">
          <h5 className="font-semibold text-[18px] group-hover:text-[#362bd6] mb-2">
            {title}
          </h5>
          {startingBid && (
            <p className="text-stone-600 font-light">
              Starting Bid:{" "}
              <span className="text-[#8890fd] font-bold ml-1">
                {startingBid}
              </span>
            </p>
          )}
          <p className="text-stone-600 font-light">
            ...
            {Object.keys(timeLeft).length > 1 ? (
              ...
              <span className="text-[#8890fd] font-bold ml-1">Time's up!</span>
            )}
          </p>
        ...
        <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
          ...
          <form className="flex flex-col gap-5 my-5">
            ...
            <div>
              <button
                type="button"
                className="bg-green-500 flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300"
