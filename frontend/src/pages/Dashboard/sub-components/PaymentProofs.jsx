...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  ...
  return (
    <>
      <section
        className={`fixed ${openDrawer && singlePaymentProof.userId ? "bottom-0" : "opacity-0 visibility-hidden"} left-0 w-full transition-all duration-300 h-full bg-[#00000087] flex items-end`}
      >
          ...
          <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
            ...
            <form className="flex flex-col gap-5 my-5">
              ...
              <div>
                <button
                  type="button"
                  className="bg-green-500 flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300 hover:bg-blue-700"
